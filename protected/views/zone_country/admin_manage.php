...
<?php $this->renderPartial('/zone_country/_search',array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Search ?>
...
<div class="grid-form">
<?php $this->renderPartial('/zone_country/_option_form',array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Grid Option ?>

<div id="partial-ommu-zone-country">
	<?php //begin.Messages ?>
	<div id="ajax-message">
	<?php
