...
<?php $this->renderPartial('/zone_province/_search',array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Search ?>
...
<div class="grid-form">
<?php $this->renderPartial('/zone_province/_option_form',array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Grid Option ?>

<div id="partial-ommu-zone-province">
	<?php //begin.Messages ?>
	<div id="ajax-message">
	<?php
