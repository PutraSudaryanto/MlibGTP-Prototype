...
class MenucategoryController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = OmmuMenuCategory::model()->findByPk(1,array(
		...
		$dataProvider = new CActiveDataProvider('OmmuMenuCategory', array(
			'criteria'=>$criteria,
			'pagination'=>array(
				'pageSize'=>10,
			),
		...
		$this->pageTitle = 'Ommu Menu Categories';
		$this->pageDescription = $setting->meta_description;
		$this->pageMeta = $setting->meta_keyword;
		$this->render('/menu_category/front_index',array(
	...
	public function actionView($id) 
	{
		...
		$this->pageTitle = 'View Ommu Menu Categories';
		$this->pageDescription = '';
		$this->pageMeta = $setting->meta_keyword;
		$this->render('/menu_category/front_view',array(
			'model'=>$model,
		));
		/*
	...
	public function actionManage() 
	{
		...
		$this->pageTitle = 'Ommu Menu Categories Manage';
		$this->pageDescription = '';
		$this->pageMeta = '';
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['OmmuMenuCategory'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', 'OmmuMenuCategory success created.');
		...
		$this->pageTitle = 'Create Ommu Menu Categories';
		$this->pageDescription = '';
		$this->pageMeta = '';
	...
	public function actionEdit($id) 
	{
		...
		if(isset($_POST['OmmuMenuCategory'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', 'OmmuMenuCategory success updated.');
					//$this->redirect(array('view','id'=>$model->cat_id));
					$this->redirect(array('manage'));
				}
			}
		...
		$this->pageTitle = 'Update Ommu Menu Categories';
		$this->pageDescription = '';
		$this->pageMeta = '';
	...
	public function actionDelete($id) 
	{
		...
		if(Yii::app()->request->isPostRequest) {
			...
			$this->pageTitle = 'OmmuMenuCategory Delete.';
			$this->pageDescription = '';
			$this->pageMeta = '';
